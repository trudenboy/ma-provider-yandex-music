...
Откройте веб-интерфейс MA по адресу `http://localhost:8095`, затем перейдите в **Настройки → Музыкальные источники → Добавить источник → Яндекс Музыка** и пройдите пошаговую авторизацию. По умолчанию используется QR-код; также доступны Device Code и ручной ввод существующего токена.
...
|-------------|----------|
| [Настройка](docs/configuration.md) | QR, Device Code, ручной токен, повторная авторизация и параметры воспроизведения |
