...
Этот провайдер использует **неофициальный** клиент [Yandex Music API](https://github.com/MarshalX/yandex-music-api) и не аффилирован с компанией Яндекс. API может измениться без предупреждения, что может привести к временной неработоспособности провайдера.
:::
